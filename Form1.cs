...
namespace Knowledge_Competition
{
    public partial class Form1 : Form
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            {
                richTextBox1.Text = "  \n    Which is the most successful football team in the world in August 2000 according to International Football History and Statistics Federation's(IFFHS) assessment?";
                btnA.Text = "Galatasaray";
                btnB.Text = "Barcelona";
